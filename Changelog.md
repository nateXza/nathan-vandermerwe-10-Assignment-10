...
- Completed creational design patterns (Assignment 10).
- Added unit tests for all patterns.
- Updated README with language choice justification and pattern rationales.

## Version 0.8.0 (2025-04-10)
- Designed and implemented class diagrams.
- Reflected on challenges faced during class diagram development.
- Updated GitHub repository with domain model documentation.

## Version 0.7.0 (2025-04-05)
- Defined functional and non-functional requirements.
- Conducted stakeholder analysis.
- Updated system requirements document.

## Version 0.6.0 (2025-03-30)
- Created use case diagrams and specifications.
- Developed test cases for functional and non-functional requirements.
